      ...
      <div className='w-full h-full drop-shadow-2xl shadow-2xl flex flex-col bg-[#722f2f] min-h-52 !text-light-100 rounded-xl'>
        <div className='flex justify-between items-center h-20 bg-[#3d1a1a] px-8'>
          <div className='flex py-2 h-8 w-8 items-center gap-x-3'>
            <img src='/icons/sarc.svg' className='object-contain h-10 w-10' />
            <h2 className='font-semibold text-white'>sPONIX</h2>
          </div>
          <div>
        ...
        <div className='flex flex-col gap-y-6 px-8 py-10 !text-white'>
          <div className='flex flex-col gap-y-2'>
            ...
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>My Ponix Balance</p>
              <p className='font-semibold text-white'>0.00</p>
            </div>
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>My sPonix Balance</p>
              <p className='font-semibold text-white'>0.00</p>
            </div>
            <hr className='' />
          </div>
          <div className='flex flex-col gap-y-2'>
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>My Pending Fees</p>
              <p className='font-semibold text-white'>0.00</p>
            </div>
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>My Claimed Fees</p>
              <p className='font-semibold text-white'>0.00</p>
            </div>
            {/* <div className='flex justify-between items-center'>
...
export default SPONIXComponent
