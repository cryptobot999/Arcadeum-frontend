      ...
      <div className='w-full h-full drop-shadow-2xl shadow-2xl flex flex-col bg-[#722f2f] min-h-52 !text-light-100 rounded-xl'>
        <div className='flex justify-between items-center h-20 bg-[#3d1a1a] px-8'>
          <div className='flex py-2 h-8 w-8 items-center gap-x-3'>
            <img src='/icons/logo.png' className='object-contain h-10 w-10' />
        ...
        <div className='flex flex-col gap-y-6 px-8 py-10 !text-white'>
          <div className='flex flex-col gap-y-2'>
            ...
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>Ponix Balance</p>
              <p className='font-semibold text-white'>35168.19</p>
            </div>
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>sPonix Balance </p>
              <p className='font-semibold text-white'>20,234</p>
            </div>
            <hr className='' />
          </div>
          <div className='flex flex-col gap-y-2'>
            <div className='flex justify-between items-center'>
              ...
              <p className='font-semibold text-white'>35.78</p>
            </div>
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>Claimed Fees</p>
              <p className='font-semibold text-white'>825.66</p>
            </div>
          ...
          <div className='flex gap-x-2'>
            <button className='px-4 py-1 bg-[#d55050] text-white rounded-lg'>
              <a
