...
// }
//
const USDTVaultModal = (props: Props) => {
        ...
        <div className=''>
          <div className='columns'>
            <div className='flex flex-col gap-y-3'>
              <h2 className='modal-title is-size-4 mb-4 text-xl font-semibold'>Stake USDT</h2>
              <p className='modal-header svelte-zislki'>
                My USDT Balance:{' '}
                <span className='modal-header-white svelte-zislki'>0.000000000000000000</span>
              </p>{' '}
              <div className='field'>
                <label className='label svelte-zislki'>USDT to Stake</label>{' '}
                <div className='flex items-center w-full gap-x-5 py-1'>
                  <input
                    ...
                    placeholder='1000.00'
                  />{' '}
                  <button className='px-7 py-2 bg-[#d6904e] hover:bg-[#a75339] text-white rounded-md'>Max</button>
                </div>{' '}
                ...
                <div className='control'>
                  {!isConnected ? (
                    <div className='flex items-center gap-x-2'>
                      <button
                        className='px-7 py-2 bg-[#d6904e] hover:bg-[#a75339] text-white rounded-md'
      ...
      <div className='w-full h-full drop-shadow-2xl shadow-2xl flex flex-col bg-[#722f2f] min-h-52 !text-light-100 rounded-xl'>
        <div className='flex justify-between items-center h-20 bg-[#3d1a1a] px-8'>
          <div className='flex py-2 h-8 w-8 items-center gap-x-3'>
            <img src='/icons/usdt.png' className='object-contain h-10 w-10' />
            <h2 className='font-semibold text-white'>USDTVault</h2>
          </div>
          <div>
        ...
        <div className='flex flex-col gap-y-6 px-8 py-10 !text-white'>
          <div className='flex flex-col gap-y-2'>
            ...
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>Staked USDT Balance</p>
              <p className='font-semibold text-white'>0.00</p>
            </div>
            <hr className='' />
          </div>
          <div className='flex flex-col gap-y-2'>
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>Pending Fees</p>
              <p className='font-semibold text-white'>0.00</p>
            </div>
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>Claimed Fees</p>
              <p className='font-semibold text-white'>0.00</p>
            </div>
            {/* <div className='flex justify-between items-center'>
              <p className='font-semibold'>Burnt Tokens (xARC)</p>
              <p className='font-semibold text-white'>56,390.636 (0.564%)</p>
            </div>
            <div className='flex justify-between items-center'>
              <p className='font-semibold'>Escrowed Tokens (esARC)</p>
          ...
          <div className='flex gap-x-2'>
            <button
              ...
              className='px-4 py-1 bg-[#d55050] text-white rounded-lg'
            >
              Stake
            </button>
            <button className='px-4 py-1 bg-[#d55050] text-white rounded-lg'>Unstake</button>
...
export default USDTVaultComponent
